const Introduction = () => {
   ...
   return (
      <section className="lg:grid lg:grid-cols-12 lg:h-[115vh] xsm:mx-6 lg:mx-10 mt-4 lg:mt-0" id="Home"> {/* The size of the screens must be 115vh on lg for the space that would be the header */}
